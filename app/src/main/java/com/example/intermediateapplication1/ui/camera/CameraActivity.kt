package com.example.intermediateapplication1.ui.camera
...
import com.example.intermediateapplication1.databinding.ActivityCameraBinding
    ...
    private val orientationEventListener by lazy {
        object : OrientationEventListener(this) {
            override fun onOrientationChanged(p0: Int) {
                if (p0 == ORIENTATION_UNKNOWN) {
                    return
                }
                val rotation = when (p0) {
